...
public class SearchActions {
	public static class SearchAction extends Action implements ISelectionChangedListener, IDocumentLoadUnloadListener {
		...
		public SearchAction() {
			super("&Search", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/search.png"))));
	...
	public static class NextSearchHitAction extends Action {
		...
		public NextSearchHitAction () {
			super("&Next Search Hit", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/next_search_hit.png"))));
	...
	public static class PreviousSearchHitAction extends Action {
		...
		public PreviousSearchHitAction () {
			super("&Previous Search Hit", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/prev_search_hit.png"))));
	...
	public static class NextSearchItemAction extends Action {
		...
		public NextSearchItemAction() {
			super("Next Search &Item", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/next_search_item.png"))));
	...
	public static class PreviousSearchItemAction extends Action {
		...
		public PreviousSearchItemAction() {
			super("Previous Search I&tem", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/prev_search_item.png"))));
