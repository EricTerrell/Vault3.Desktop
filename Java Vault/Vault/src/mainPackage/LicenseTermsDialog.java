...
public class LicenseTermsDialog extends VaultDialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		try {
			String filePath = MessageFormat.format("{0}{1}LicenseTerms.txt", FileUtils.getRootPath(), PortabilityUtils.getFileSeparator());
			licenseTermsText = FileUtils.readFile(filePath);
