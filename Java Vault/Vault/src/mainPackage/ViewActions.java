...
public class ViewActions {
	...
	public static class MoveVerticalSplitAction extends Action {
		...
		public MoveVerticalSplitAction() {
			super("Move Vertical S&plit", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/move_vertical_split.png"))));
	...
	public static class MoveHorizontalSplitAction extends Action implements ISelectionChangedListener {
		...
		public MoveHorizontalSplitAction() {
			super("Move Horizontal S&plit", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/move_horizontal_split.png"))));
			setId(HelpUtils.helpIDFromClass(this));
		}
	...
	public static class MaximizeOutlineAction extends Action {
		...
		public MaximizeOutlineAction() {
			super("Maximize &Outline", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/maximize_outline.png"))));
			setId(HelpUtils.helpIDFromClass(this));
		}
	...
	public static class MaximizeTextAndPhotosAction extends Action {
		...
		public MaximizeTextAndPhotosAction() {
			super("Maximize &Text / Photo", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/maximize_textphotos.png"))));
			setId(HelpUtils.helpIDFromClass(this));
		}
	...
	public static class ViewOutlineAndTextPhotos extends Action {
		...
		public ViewOutlineAndTextPhotos() {
			super("&Display Outline and Text / Photo", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/view_outline_and_textphotos.png"))));
		}
	...
	public static class SlideShowAction extends Action implements ISelectionChangedListener, IDocumentLoadUnloadListener {
		...
		public SlideShowAction() {
			super("S&lide Show...", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/slideshow.png"))));
