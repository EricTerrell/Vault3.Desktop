...
public class HelpActions {
	public static class AboutAction extends Action {
		...
		public AboutAction() {
			super("&About...", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/question.png"))));
	...
	public static class HelpTopicsAction extends Action {
		...
		public HelpTopicsAction() {
			super("On-Line Help", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/help.png"))));
