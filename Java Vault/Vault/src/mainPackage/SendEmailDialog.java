...
public class SendEmailDialog extends VaultDialog {
	...
	protected void populateFields() {
		...
		photoPaths.stream().filter(photoPath -> photoPath != null).forEach(photoPath -> attachmentsList.add(photoPath));
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		toText.addModifyListener(e -> enableDisableSendButton());
		...
		parent.addHelpListener(e -> HelpUtils.ProcessHelpRequest("Dialogs_SendEmailDialog"));
