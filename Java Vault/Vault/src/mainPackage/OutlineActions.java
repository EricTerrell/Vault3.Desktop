...
public class OutlineActions {
	public static class CutAction extends Action implements ISelectionChangedListener {
		...
		public CutAction() {
			super("&Cut", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/cut.png"))));
	...
	public static class CopyAction extends Action implements ISelectionChangedListener {
		...
		public CopyAction() {
			super("Cop&y", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/copy.png"))));
	...
	public static class PasteAction extends Action implements ISelectionChangedListener, IClipboardListener {
		...
		public PasteAction() {
			super("Pa&ste", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/paste.png"))));
			setEnabled(false);
	...
	public static class AddAction extends Action implements ISelectionChangedListener {
		...
		public AddAction() {
			super("&Add...", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/add.png"))));
	...
	public static class RemoveAction extends Action implements ISelectionChangedListener {
		...
		public RemoveAction() {
			super("Remo&ve...", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/delete.png"))));
	...
	public static class ImportPicturesAction extends Action implements ISelectionChangedListener {
		...
		public ImportPicturesAction() {
			super("Impo&rt Photos...", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/import_pictures.png"))));
	...
	public static class MoveAction extends Action implements ISelectionChangedListener {
		...
		public MoveAction() {
			super("&Move...", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/move.png"))));
	...
	public static class ExpandAction extends Action implements ISelectionChangedListener, ITreeViewerListener, IDocumentLoadUnloadListener {
		...
		public ExpandAction() {
			super("&Expand", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/expand.png"))));
	...
	public static class ExpandAllAction extends Action implements ITreeViewerListener, IDocumentLoadUnloadListener {
		...
		public ExpandAllAction() {
			super("E&xpand All", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/expand_all.png"))));
			setEnabled(false);
			setId(HelpUtils.helpIDFromClass(this));
		}
	...
	public static class CollapseAction extends Action implements ISelectionChangedListener, ITreeViewerListener, IDocumentLoadUnloadListener {
		...
		public CollapseAction() {
			super("Colla&pse", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/collapse.png"))));
	...
	public static class CollapseAllAction extends Action implements ITreeViewerListener, IDocumentLoadUnloadListener {
		...
		public CollapseAllAction() {
			super("Collapse All", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/collapse_all.png"))));
			setEnabled(false);
			setId(HelpUtils.helpIDFromClass(this));
		}
	...
	public static class EditAction extends Action implements ISelectionChangedListener {
		...
		public EditAction() {
			super("Ed&it...", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/edit.png"))));
	...
	public static class SortAction extends Action implements ISelectionChangedListener {
		...
		public SortAction() {
			super("&Sort", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/sort.png"))));
			setEnabled(false);
			setId(HelpUtils.helpIDFromClass(this));
		}
	...
	public static class SetFontAction extends Action {
		...
		public SetFontAction() {
			super("Set &Font...", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/font.png"))));
			setEnabled(true);
			setId(HelpUtils.helpIDFromClass(this));
		}
