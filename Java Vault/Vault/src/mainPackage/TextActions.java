...
public class TextActions {
	public static class InsertDateAction extends Action implements ITextListener {
		...
		public InsertDateAction() {
			super("&Insert Date", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/calendar.png"))));
			setEnabled(false);
	...
	public static class InsertTimeAction extends Action implements ITextListener {
		...
		public InsertTimeAction() {
			super("Insert Ti&me", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/clock.png"))));
			setEnabled(false);
			setId(HelpUtils.helpIDFromClass(this));
		}
	...
	public static class UndoAction extends Action implements ITextListener {
		...
		public UndoAction() {
			super("&Undo", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/undo.png"))));
	...
	public static class CutAction extends Action implements ISelectionChangedListener {
		...
		public CutAction() {
			super("Cu&t", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/cut.png"))));
	...
	public static class PasteAction extends Action {
		...
		public PasteAction() {
			super("&Paste", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/paste.png"))));
	...
	public static class InsertTextFileAction extends Action implements ISelectionChangedListener {
		...
		public InsertTextFileAction() {
			super("Insert Te&xt File...", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/insert_text_file.png"))));
			setEnabled(false);
			setId(HelpUtils.helpIDFromClass(this));
		}
	...
	public static class SetFontAction extends Action implements ISelectionChangedListener {
		...
		public SetFontAction() {
			super("Set F&ont...", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/font.png"))));
			setEnabled(false);
			setId(HelpUtils.helpIDFromClass(this));
		}
	...
	public static class GoToWebsitesAction extends Action {
		...
		public GoToWebsitesAction() {
			super("Browse &URLs...", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/web.png"))));
	...
	public static class FindAction extends Action implements ITextListener {
		...
		public FindAction() {
			super("&Find...", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/find.png"))));
	...
	public static class ReplaceAction extends Action implements ITextListener {
		...
		public ReplaceAction() {
			super("&Replace...", ImageDescriptor.createFromImage(new Image(Display.getCurrent(), MainApplicationWindow.class.getResourceAsStream("artwork/text_replace.png"))));
