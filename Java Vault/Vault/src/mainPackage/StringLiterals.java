...
public class StringLiterals {
	...
	public static final String ProgramFileTypeWildcarded                = "*.vl3";
	public static final String ProgramFileTypeWildcardedCaseInsensitive = "*.vl3;*.VL3";
	public static final String XMLFileTypeWildcarded                    = "*.xml";
	public static final String XMLFileTypeWildcardedCaseInsensitive     = "*.xml;*.XML";
